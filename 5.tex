...
\end{tcolorbox}
  ...
  \section{Analysis of exponential time integration methods}
    ...
    \subsection{Industrial application: LS89}
      ...
      \paragraph{}
      The reason why we decided to use exponential methods for this numerical application is that is previous works, the explicit time step was limited by the viscous effect that prevail in the small cells of the boundary layer.
