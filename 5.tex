\chapter{Exponential integration methods in JAGUAR}
  ...
  \section{Analysis of exponential time integration methods}
    ...
    \subsection{Order: convected inviscid isentropic vortex}
      ...
      It means that the error from accurate methods on coarse meshes with a low-order Spectral Difference method will not represent the error from the time integration method, 
