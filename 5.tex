...
\end{tcolorbox}
  ...
  \section{Analysis of exponential time integration methods}
    ...
    \subsection{Robustness analysis: Taylor--Green vortex}
      ...
      They all give the same result, which is \GP{our reference solution for the considered mesh and the set of parameters of the study}.
      Finally, as those methods give similar physical results, analyzing their statistics could be an efficient way to compare them.
      %Finally, as we compare methods that give similar physical results, what interests us is their statistics.
    ...
    \subsection{Industrial application: LS89}
      ...
      It was originally true at the time of some previous investigations \cite{BrunetCronerMinotEtAl2018}, but as the diffusive scheme was greatly improved \cite{Marchal2023}, it is not true anymore.
