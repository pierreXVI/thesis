  ...
  \GP{Comparison between full-Jacobian matrix and matrix-free formulations}
    ...
    \subsection{Turbulent transonic airfoil}
      ...
      \subsubsection{Analysis of the results}
        ...
        \LM{J'avoue que mes souvenirs sont assez vague, mais il me semblait que la norme L2 était la racine de l'intégrale des carré; ce que tu écris ne serait pas la norme L1 plutôt?}
        \PS{Oups ... en plus elle est normalisée par le volume.}
        \begin{equation}
