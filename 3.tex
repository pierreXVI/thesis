  ...
  \GP{Comparison between full-Jacobian and matrix-free formulations}
    ...
    \subsection{Turbulent transonic airfoil}
      ...
      \subsubsection{Definition of the test case}
        ...
        The spatial discretisation method is a second-order Finite Volume method, using the HLLC Riemann solver and Multislope method\footnote{\GP{Citer le papier de Le Touze, Murrone et Guillard sur JCP?}\PS{C'est déjà fait quand j'introduis les méthodes de reconstructions, je peux la remettre}} with a Van--Leer slope limiter.
    ...
    \subsection{Turbulent transonic airfoil with boundary layer resolution}
      ...
      \subsubsection{Analysis of the results}
        ...
        \PS{TODO: MF a un $\Delta t$ 10 fois plus grand.}
        ...
        \begin{figure}
          \centering
          % \includegraphics{figures/rae_residuals_fine.png}
          \caption{\PS{TODO}}
