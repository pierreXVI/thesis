  ...
  \section{Utilisation de la formulation sans matrice sur un nouveau modèle de fluide}
    ...
    \subsection{Modèle Multi-températures}
      ...
      \begin{itemize}
        ...
        \item the \emph{light} ones that are at \PS{vibrational desiquilibrium}
      ...
      \begin{equation}
        ...
        \end{alignedat}\right.
      \end{equation}
      We notice there are multiple energies corresponding to the multiple temperatures: $e_e$ the energy of the electronic gas, $e_{v, m}$ the vibrational energy for each flow component that may be at desiquilibrium, and $E$ the rest of the energy.
      ...
      The details of those terms can be complex and are not discussed here, as it is not the subject of this thesis.
      ...
      This is a known issue of this model, as Finite Volume method handles best conservative terms, but it appears necessary to get physically acurate results.
