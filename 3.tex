    ...
    \subsection{Hypersonic reactive sphere}
      ...
      \subsubsection{Analysis of the results}
        ...
        \begin{figure}
          ...
          \caption{\PS{TODO}Residual 1-norms for the horizontal and vertical momentum components, energy and \ce{N_2} mass throughout the computation for the hypersonic reactive sphere case.
          Values are normalised by the initial residual.}
  ...
  \section{Utilisation de la formulation sans matrice sur un nouveau modèle de fluide}
    ...
    \subsection{Hypersonic reactive sphere}
      ...
      \subsubsection{Full reactive model}
        ...
        This is why the computation starts with some iterations of the Midpoint method.
        Then, it continues with the JFNK method using the first-order Finite Volume method, to quickly get a good enough approximation of the expected solution.
