\chapter{Analyse de la méthode JFNK dans CEDRE}
  ...
  \section{Comparaison entre la matrice jacobienne explicite et la formulation sans matrice}
    ...
    \subsection{Hypersonic reactive sphere}
      ...
      \paragraph{}
      The second application we selected to compare the Jacobian Free Newton--Krylov with the traditional one is the computation of the flow around a hypersonic sphere.
      ...
      \subsubsection{Definition of the test case}
        ...
        \paragraph{}
        The mesh is 2D axisymetric and is shown in figure \PS{TODO} 
