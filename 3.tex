  ...
  \GP{Comparison between full-Jacobian matrix and matrix-free formulations}
    ...
    \subsection{Turbulent transonic airfoil}
      ...
      \subsubsection{Analysis of the results}
        ...
        \begin{figure}
          ...
          \caption{Residual 1-norms for the two momentum components, energy and turbulent viscosity throughout the computation.
    ...
    \subsection{Turbulent transonic airfoil with boundary layer resolution}
      ...
      \subsubsection{Analysis of the results}
        ...
        \begin{figure}
          ...
          \caption{Residual 1-norms for the horizontal and vertical momentum components, energy and turbulent viscosity throughout the computation.
          Values are normalised by the initial residual.}
    ...
    \subsection{Hypersonic reactive sphere}
      ...
      \subsubsection{Analysis of the results}
        ...
        \paragraph{}
        To analyse the result from this case, one might look at the residuals once again.
        The first result correspond to a computaion without electrons or ions.
        It means only 5 species are used.
        This simplification makes sense as the case without ionisation still interest researchers but is easier in terms of numerical complexity.
        ...
        The residual 1-norms are shown 
    ...
    \subsection{Hypersonic reactive sphere}
      ...
      \subsubsection{Full reactive model}
        ...
        \begin{figure}
          ...
          \caption{Residual 1-norms for the electron mass fraction, vertical momentum, \ce{N_2} vibrational energy and total energy for the Multi-TEmperature model computation.
          Values are normalised by the initial residual.}
