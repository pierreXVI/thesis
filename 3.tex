\chapter{Analyse de la méthode JFNK dans CEDRE}
  ...
  \section{Utilisation de la formulation sans matrice sur un nouveau modèle de fluide}
    ...
    \subsection{Multi-TEmperature model}
      ...
      Its difference with the traditional Navier--Stokes model is that is allows for a non thermal equilibrium of some flow \PS{components}.
      ...
      The source termes $S$ correspond to the energy transfers between the different energy modes.
      ...
      This is a known issue of this model, as Finite Volume method handles best conservative terms.
      ...
      Computing the electronic density can also be useful when studying \PS{signature electromagnetique} or handling particules electric charges.
    ...
    \subsection{Hypersonic reactive sphere}
      ...
      This limits the MTE model users to explicit time integration methods, and therefore to small time steps for stability reasons.
      ...
      The goal here is to be able to get a steady solution of the problem as fast as possible for the user.
      ...
      \subsubsection{Modèle réactif complet}
        ...
        \paragraph{}
        The goal of this thesis is not the physical analysis of this test case so it will be left out, but according to the MTE model users the results are in accordance with the literature. \PS{Ca va ?}
        We show in figure \PS{TODO} the various temperatures along the symmetry axis.
        This justify the use of the Multi-Temperature model: the region downstream of the shock is indeed in a thermodynamic non-equilibrium state.
        ...
        What matters to us and to an user is not the number of iterations.
        ...
        \PS{Ou CPU time, ça fait plus scientifique ?}
