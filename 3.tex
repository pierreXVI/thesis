\chapter{Analyse de la méthode JFNK dans CEDRE}
  ...
  \section{Comparaison entre la matrice jacobienne explicite et la formulation sans matrice}
    ...
    \PS{MAYBE ?}
      ...
      \subsubsection{Definition of the test case}
        ...
        \paragraph{}
        The previous case use a mesh that is too coarse to resolve the boundary layer but instead uses a turbulent wall mode.
        It is representative of CEDRE applications, but not of actual applications is the aerodynamic community.
        ...
        This means that we do not need to use the turbulent wall model we used on the previous test case.
        ...
        We take a Mach number equal to 0.729, the angle of attack is $2.31\si{\degree}$ with a Reynolds number of \num{6.5e6}.
        \PS{TODO}
  ...
  \section{Utilisation de la formulation sans matrice sur un nouveau modèle de fluide}
    ...
    \subsection{Multi-TEmperature model}
      ...
      This term is due to the effet of the electric field.
      ...
      Not to go into too much details, such models that account for thermodynamic disequilibrium are still under discussion as of today \cite{BlancoJosyula2020}.
