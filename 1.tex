...
\end{tcolorbox}
  ...
  \section{Brief introduction to the spatial integration schemes}
    ...
    \subsection{The Finite Volume method}
      ...
      In the case of the Navier--Stokes equations (\ref{eq:ns}), the density, the momentum and the energy are conserved throughout time, apart from \PS{fluxes going through domain boundaries}.
