\chapter{Analysis of existing methods}
  ...
  \section{Problem setup}
    ...
    \LM{Si tu en es à dire qu'il y a plusieurs modèles pour $\tau$, n'hésite pas à signaler que la fermeture que tu exhibes ici pour $\rho E$ est la plus simple possible (gaz parfait cp constant)... Elle n'est en pratique que rarement utilisée...}
  ...
  \section{Brief introduction to the spatial integration schemes}
    ...
    \subsection{The Finite Volume method}
      ...
      The cells from our meshes are polygons.\LM{polyhedron? Mais est-ce vraiment le cas?}
