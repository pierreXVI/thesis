\chapter{Analysis of existing methods}
  ...
  \PS{Revoir structure}
    ...
    \subsection{Evaluating the Jacobian matrices}
      ...
      That is why we will use the approximation (\ref{eq:matrix_free}) instead of recomputing the Jacobian matrix first.
      ...
      This methods and its variants are as of today still discussed \cite{KnollKeyes2004, Turpault2003} and used on actual computational fluid dynamics solvers \cite{LiuZhangZhongEtAl2015, FrancoCamierAndrejEtAl2020}.
