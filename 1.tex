...
\end{tcolorbox}
  ...
  \section{Problem setup}
    ...
    \paragraph{}
    In this work, attention is paid \reviewers{to} computational fluid dynamics and in particular to \reviewers{solving} the Navier--Stokes equation and its variants: the reactive Navier--Stokes equation, the Reynold-averaged Navier--Stokes equation, etc.
  ...
  \section{Implicit methods framework}
    ...
    \subsection{Linear solver}
      ...
      Instead, one can use iterative methods \reviewers{\cite{OlshanskiiTyrtyshnikov2014}}.
      ...
      This was originally conceived to preserve the conservative properties through the GMRES \reviewers{solver}.
