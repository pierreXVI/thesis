  ...
  \section{Introduction to the time integration methods}
    ...
    \subsection{Explicit methods}
      ...
      \subsubsection{Runge--Kutta methods}
        ...
        \paragraph{}
        Instead of making one step forward in time as the explicit Euler method, Runge--Kutta method will make a set of intermediate steps, and find the final solution as a combination of those intermediate steps.
