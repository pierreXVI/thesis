...
\end{tcolorbox}
  ...
  \section{Introduction to the time integration methods}
    ...
    \subsection{Analysis of time integration methods}
      ...
      \subsubsection{Stability}
        ...
        \footnote{
          \LM{On comprend bien ce que tu veux dire, mais, n'y a-t-il pas un terme plus précis pour qualifier la solution $\tilde{\Xi}$, du genre qu'elle est linéairement stable, ou autre chose? Si non, ben tant pis c'est pas grave...}
          \GP{Je ne crois pas qu'on puisse faire mieux, sauf à passer sur les notions de stabilité générales, comme expliqué dans la thèse de Muscat https://cerfacs.fr/wp-content/uploads/2019/05/CFD-MUSCAT-PHD.pdf en page 16}
          \PS{Je ne vois pas ce que dont tu parles dans la thèse de Laurent}
        }
  ...
  \section{Implicit methods framework}
    ...
    \subsection{Linear solver}
      ...
      An amusing\footnote{\GP{funny} \PS{Pourquoi pas amusing ?}} result is found in \cite{GreenbaumPtakStrakos1996}.
      ...
      \GP{Tu ne dis pas pourquoi... Quelques mots pourraient suffire pour expliquer d'où ça vient...}
    ...
    \subsection{Evaluating the Jacobian matrices}
      ...
      \PS{Finding an algorithm that computes the exact Jacobian matrix analytically would amount to too much work in our industrial software.} \footnote{
        \GP{Of course, the definition of the Jacobian can always be performed by an exact differenciation of the source code, as provided by the Algorithmic Differentiation tool called Tapenade \cite{HascoeetPascual2012}.
        But for efficiency, such a procedure requires revisiting the main structures of the solver, something impossible to tackle in three years because of the number of lines of codes to treat.}
        \PS{C'est pas ce que je voulais dire}
      }
