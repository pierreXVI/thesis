...
\end{tcolorbox}
  ...
  \section{Problem setup}
    ...
    \end{equation}
    \PS{The difference here is that the function $\operatorname{G}$ is a function of a discrete vector whereas $\operatorname{F}$ was a function of continuous state variable that are in turn function on the space variable, and therefore $\operatorname{G}$ does not use any spatial derivatives.}
