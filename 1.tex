...
\end{tcolorbox}
  ...
  \section{Implicit methods framework}
    ...
    \subsection{Linear solver}
      ...
      For the spatial discretisation methods we use, a cell only depends on a small number of neighbouring cells, and therefore a degree of freedom is not linked with most of the others \PS{(c'est clair ?)}.
