\chapter{Analysis of existing methods}
  ...
  \section{Time integration methods}
    ...
    As we will mostly look at single steps of the time integration methods in the following, we will drop the subscript on the time step when it is meaningless.
    ...
    \subsection{Analysis of time integration methods}
      ...
      \subsubsection{Stability}
        ...
        \begin{equation}
          J = \begin{pmatrix} -1 & 0 \\ 0 & 10^3 \end{pmatrix}, \quad \Xi_0 = \begin{pmatrix} 1 \\ 0 \end{pmatrix} \ .
        \end{equation}
        The solution of the equation is then :
        \begin{equation}
          \Xi\left(t\right) = \begin{pmatrix} e^{-t} \\ 0 \end{pmatrix} \ .
        \end{equation}
        ...
        \begin{equation}
          \Xi_0' = \begin{pmatrix} 1 \\ \epsilon \end{pmatrix}
        \end{equation}
        instead of the exact one $\Xi_0$, with a typical $\epsilon = 10^{-15}$ for double precision.
        ...
        \begin{equation}
          \Xi_n = \begin{pmatrix} e^{-n\Delta t} \\ \epsilon e^{10^3 n \Delta t} \end{pmatrix}
        \end{equation}
