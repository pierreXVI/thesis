...
\end{minted}
      ...
      \paragraph{}
      The computational cost of the matrix vector approximation is approximately the cost of one function evaluations.
      It requires some additional operations, such as vector subtractions, vector scaling, but those operations are way less expensive.
      ...
      Practically, using it increase the computational time of one iteration.
      We now hope that as it will not improve the iteration speed, it will improve the convergence of our solver.
      Also, as we said the team responsible for CEDRE is working improve the speed of the function evaluation.
      If they succeed, their work will then benefit greatly our method.
