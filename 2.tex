...
\end{minted}
    ...
    \subsection{Linear system normalisation}
      ...
      \paragraph{}
      An available option in BIBCEDRE for the linear \reviewers{solver} is normalisation.
      ...
      This estimation can be computed at each time step depending on the current state, or can simply be constant\reviewers{,} equal to some reference values, depending on the choice of the user.
    ...
    \subsection{Preconditioning}
      ...
      \begin{itemize}
        \item The \emph{outer} left preconditioning is applied once before the linear solve.
          ...
          Once it is applied, the \reviewers{resolution} can continue as if nothing had happened.
