\chapter{Introduction to a new type of time integration methods}
...
\begin{tcolorbox}[title=Résumé du chapitre : Introduction d'un nouveau type de méthodes d'intégration temporelle, colframe=black!50!white]
  ...
  \paragraph{}
  Les méthodes utilisées dans la résolution des problèmes stationnaires sont souvent réutilisées dans la résolution de problèmes instationnaires intégrés avec de grands pas de temps.
  ...
  Nous réalisons également une brève analyse théorique ce ces méthodes.
