...
\end{tcolorbox}
  ...
  \section{Exponential Runge--Kutta and Rosenbrock methods}
    ...
    \end{equation}
    They are used when the remainder $r$ is small \LM{$r = g$ ici?} or at least bounded in terms of $A$.
  ...
  \section{Evaluating matrix functions}
    ...
    \subsection{Evaluating matrix functions with Krylov subspace methods}
      ...
      \PS{GP tu avais mis en italique, c'était juste pour mettre en valeur ta correction ?}
