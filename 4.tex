\chapter{Analysis of a new type of time integration methods}
  ...
  \section{Evaluating matrix exponential}
    ...
    The idea, originally developed to approximate eigenvalues of a large sparse matrix, is to use a Krylov subspace method to approximate $g\left(A\right)b$ \cite{Sidje1998}.
