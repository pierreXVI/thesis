...
\end{tcolorbox}
  ...
  \section{Evaluating matrix functions}
    ...
    \PS{The question of how to evaluate $\varphi$-functions in the context of exponential methods is a subject of active research, as this extremely recent reference shows \cite{CaliariCassiniZivcovich2023}.
    We will however use more classical algorithms, that are tried and true.}
    ...
    \subsection{Evaluating matrix functions with Krylov subspace methods}
      ...
      \PS{For exponential methods, $h$ is a linear combination of $\varphi$-functions, and is therefore analytic.}
